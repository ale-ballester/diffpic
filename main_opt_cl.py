...
optimizer = Optimizer(pic=pic,model=E_control,K=K,y0=y0,loss_metric=loss_metric_density_modes,lr=1e-2,save_dir="model_cl/")
...
plot_modes(pic.ts, u, max_mode_spect=4, max_mode_time=4, boxsize=boxsize, name=r"External field", label=r"$\hat E_{ext}$", num=6, zero_mean=True, save_path="plots/trained_cl/external_field_modes.png")
